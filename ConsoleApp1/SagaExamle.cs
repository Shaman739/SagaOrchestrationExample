...
//                    new WorkItem<ReserveFlightActivity>(new WorkItemArguments{{"destination1", "DUS"}})
//                });
...
//            var car = workItem.Arguments.ContainsKey("destination") ? workItem.Arguments["destination"] : workItem.Arguments["fatzbatz"]; // this throws
//            var reservationId = rnd.Next(100000);
